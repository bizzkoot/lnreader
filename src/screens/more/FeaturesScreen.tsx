    ...
    items: [
      ...
      },
      {
        ...
        detailedGuide: [
          'Start TTS playback.',
          'Tap center -> "TTS" tab.',
          'Scroll to "Highlight Offset" controls (+/- buttons).',
      ...
      },
      {
        ...
        desc: 'Chapter list updates live during TTS playback with 2-second debounce for accuracy.',
        location: 'Works automatically',
        detailedGuide: [
          'Start TTS playback on any chapter.',
          'Navigate to Chapter List.',
          'Progress bar updates in real-time as you listen.',
          'No need to stop/restart TTS to see progress.',
        ],
      },
      {
        icon: 'arrow-up-bold-circle',
        title: 'Wake Scroll Restoration',
        desc: 'Reader automatically scrolls to your last TTS paragraph when returning to the app.',
        location: 'Works automatically',
        detailedGuide: [
          'Start TTS playback.',
          'Lock screen or switch apps.',
          'Return to the app.',
          'Reader scrolls to the last spoken paragraph automatically.',
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        desc: 'Encrypt DNS queries with Cloudflare, Google, or AdGuard providers for enhanced privacy and security.',
        location: 'Settings → Advanced → DoH Provider',
        detailedGuide: [
          'Go to "More" tab -> Settings.',
          'Tap "Advanced".',
          'Find "DoH Provider" section.',
          'Choose between Cloudflare (default), Google, or AdGuard.',
          'App will restart to apply the new DNS provider.',
        ],
      },
      {
        icon: 'cookie',
        title: 'Cookie Management',
        desc: 'Automatic login persistence for sources that require authentication. Your sessions stay active across app restarts.',
        location: 'Settings → Advanced → Clear Cookies',
        detailedGuide: [
          'Cookies are saved automatically when you login to sources.',
          'Your login sessions persist across app restarts.',
          'To clear cookies: Go to "More" -> Settings -> Advanced.',
          'Tap "Clear Cookies" and confirm.',
        ],
      },
      {
        icon: 'shield-check',
        title: 'Cloudflare Bypass',
        desc: 'Automatic solver for Cloudflare-protected novel sources. Works seamlessly in the background with retry limits.',
        location: 'Works automatically',
        detailedGuide: [
          'When accessing a Cloudflare-protected source, the app detects the challenge.',
          'A hidden WebView solves the challenge automatically.',
          'If successful, you gain access without manual intervention.',
          'The app retries up to 2 times before showing an error.',
        ],
      },
    ],
  },
