...
const ReaderTTSTab: React.FC<ReaderTTSTabProps> = React.memo(
  ({
    novel,
    ...
    // webViewRef comes from context; novel + offset controls passed as props to work around Portal context issue
    ...
    useEffect(() => {
      debugLog('novelId useEffect triggered', {
        novelId,
        type: typeof novelId,
      });
