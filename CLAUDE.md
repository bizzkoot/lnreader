...
- **Cleared from MMKV:** pendingTTSResumeChapterId, lastTTSChapterId, chapter*progress*\*, tts_button_position
...
- **Location:** useTTSController.ts:333-389 (cleanup function), 2394-2409 (PREV), 2502-2512 (NEXT)
- **User intent:** Media notification navigation is always user-intentional, so clearing all state is safe
